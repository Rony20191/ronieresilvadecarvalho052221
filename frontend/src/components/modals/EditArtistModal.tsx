...
import { Artist, UpdateArtistRequest } from '@/core/types/artist';
...
export default function EditArtistModal({ isOpen, onClose, onSuccess, artist }: EditArtistModalProps) {
    const [formData, setFormData] = useState<UpdateArtistRequest>({
        name: '',
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Editar Artista" maxWidth="lg">
