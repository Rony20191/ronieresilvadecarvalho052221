...
class AlbumControllerTest {
        ...
        void shouldGetAlbumByIdSuccessfully() throws Exception {
                UUID albumId = UUID.randomUUID();
                AlbumResponse response = new AlbumResponse(albumId, "Album Title", null, 2023, List.of(), List.of(),
                                null,
                                null);
        ...
        void shouldSearchAlbumsSuccessfully() throws Exception {
                AlbumResponse response = new AlbumResponse(UUID.randomUUID(), "Album Title", null, 2023, List.of(),
                                List.of(),
                                null, null);
                PageImpl<AlbumResponse> page = new PageImpl<>(List.of(response));

                given(searchAlbumsUseCase.execute(any(SearchAlbumRequest.class), any(PageRequest.class)))
                                .willReturn(page);
